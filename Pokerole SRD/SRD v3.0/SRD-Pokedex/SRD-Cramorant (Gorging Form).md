...
BaseHP: 5
BeginnerMoves: []
BookSprite: SRD-cramorant-gorging-form-BookSprite.png
DexCategory: "Gulp Pok\xE9mon"
DexDescription: Cramorant's Gorging Form. Somehow it caught a Pikachu after diving.
  Can use the Move Thunderbolt.
Dexterity: 2
EventAbilities: ''
Evolutions: []
ExpertMoves:
...
Height:
  ...
  Meters: 0.8
HiddenAbility: ''
HomeSprite: SRD-cramorant-gorging-form-HomeSprite.png
Image: cramorant-gorging-form.png
Insight: 3
Legendary: false
MaxDexterity: 5
MaxInsight: 6
