...
DexDescription: A desk fan possessed by a Rotom. It uses Flying powers and scatters
  everything around with terrible air currents. While in this form it can use the
  move 'Air Slash'.
Dexterity: 2
EventAbilities: ''
Evolutions:
